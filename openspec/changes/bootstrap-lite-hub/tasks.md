...
- [ ] 6.5 Verify `.github/workflows/ci.yml` and `.github/workflows/docker-publish.yml` pass Go formatting, tests, static checks, Docker build, and Docker Hub publish after repository secrets are configured; do not mark complete until the CI run is green.
